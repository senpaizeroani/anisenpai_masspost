...
<div class="box1">
  ...
  <br><br>
  <div>
  	<input placeholder="Anime Name" id="fakeAnimeName" onkeyup="syncAnimeName()">
  </div>
   <div>
  	<input placeholder="Folgen Beginn" value="1" id="fakeep_offset" onkeyup="syncAnimeStartEpisode()">
  </div>
  <div>
  ...
  <div>
  	<textarea id="MasslinkerTextRaw" placeholder="Jede Linie kann einen Link beinhalten. Jeder Link entspricht einer Episode."
    onkeyup="getLinks()"
    onchange="getLinks()"
...
let getLinks = () => {
  ...
  for(var i = 0; i < allInputs.length; i++){
    ...
    var playerName = getNameFromLink(links[i]);
  ...
  <select class="vid_select">
      <option value="${links[i]}" data-preselect="select">${playerName}</option>
  </select>
